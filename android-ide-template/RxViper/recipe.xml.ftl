...
<recipe>
    ...
    <#if supportKotlin>
        <instantiate
            from="src/app_package/ViewCallbacks.kt.ftl"
            to="${escapeXmlAttribute(srcOut)}/${name}ViewCallbacks.kt"
        />
    <#else>
        <instantiate
            from="src/app_package/ViewCallbacks.java.ftl"
    ...
    <#if generateInteractor>
        <#if supportKotlin>
            <instantiate
                from="src/app_package/Interactor.kt.ftl"
                to="${escapeXmlAttribute(srcOut)}/${name}Interactor.kt"
            />
        <#else>
            <instantiate
                from="src/app_package/Interactor.java.ftl"
    ...
    <#if generateRouter>
        <#if supportKotlin>
            <instantiate
                from="src/app_package/Router.kt.ftl"
                to="${escapeXmlAttribute(srcOut)}/${name}Router.kt"
            />
        <#else>
            <instantiate
                from="src/app_package/Router.java.ftl"
