...
public abstract class Interactor<RequestModel, ResponseModel> implements Disposable {
   ...
   *     the Scheduler that modifies source Observable returned from {@link #createFlowable} to perform its emissions on.
   * @param observeScheduler
   *     the Scheduler that modifies source Observable returned from {@link #createFlowable} to notify its Observers on.
   *
   * @since 0.1.0
   */
